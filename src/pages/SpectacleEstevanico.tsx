            ...
            <div class="hero-left">
              <div class="hero-content">
                ...
                <div class="info-pills">
                  ...
                  <span class="info-pill">
                    <i class="fas fa-child"></i><span>${userTypeInfo.showStudyLevel ? 'CE2, CM1, CM2, Collège' : (userTypeInfo.showAgeRange ? '8 ans et +' : '')}</span>
                  </span>
                  <span class="info-pill">
            ...
            <div class="row">
                ...
                <div class="content-card" style="display: none;">
                  ...
                  <div class="gallery-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-top: 1.5rem;">
                    <div class="gallery-item" style="position: relative; border-radius: 0.75rem; overflow: hidden; cursor: pointer; transition: transform 0.3s ease;">
                      <img src="https://edjs.art/assets/img/spectacles/estevanico.png" alt="Estevanico - Photo 1" class="gallery-img" style="width: 100%; height: 200px; object-fit: cover; transition: transform 0.3s ease;">
                    ...
                    <div class="gallery-item" style="position: relative; border-radius: 0.75rem; overflow: hidden; cursor: pointer; transition: transform 0.3s ease;">
                      <img src="https://edjs.art/assets/img/spectacles elements/estevanico@4x.png" alt="Estevanico - Character" class="gallery-img" style="width: 100%; height: 200px; object-fit: cover; transition: transform 0.3s ease;">
                      <div class="gallery-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(189, 207, 0, 0.8); display: flex; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.3s ease;">
                        <i class="fas fa-expand" style="color: white; font-size: 1.5rem;"></i>
                      </div>
                    </div>
                    <div class="gallery-item" style="position: relative; border-radius: 0.75rem; overflow: hidden; cursor: pointer; transition: transform 0.3s ease;">
                      <img src="https://edjs.art/assets/img/spectacles/estavine.png" alt="Estevanico - Scene" class="gallery-img" style="width: 100%; height: 200px; object-fit: cover; transition: transform 0.3s ease;">
                      <div class="gallery-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(189, 207, 0, 0.8); display: flex; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.3s ease;">
                        <i class="fas fa-expand" style="color: white; font-size: 1.5rem;"></i>
                      </div>
                    </div>
                  ...
                  <div class="reviews-container" style="margin-top: 1.5rem;">
                    <div class="review-item" style="background: var(--bg-light); padding: 1.5rem; border-radius: 0.75rem; margin-bottom: 1rem; border-left: 4px solid var(--primary-color);">
                      <div class="review-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        <div class="review-author" style="font-weight: 600; color: var(--text-dark); font-size: 0.9rem;">Fatima R. - Professeure d'Histoire</div>
                      ...
                      <p class="review-text" style="color: var(--text-light); font-style: italic; line-height: 1.6; margin: 0;">"Une reconstitution historique fascinante ! Mes élèves ont découvert l'histoire d'Estevanico avec passion. Excellent support pédagogique."</p>
                    </div>
                    <div class="review-item" style="background: var(--bg-light); padding: 1.5rem; border-radius: 0.75rem; margin-bottom: 1rem; border-left: 4px solid var(--primary-color);">
                      <div class="review-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        <div class="review-author" style="font-weight: 600; color: var(--text-dark); font-size: 0.9rem;">Omar T. - Parent</div>
                        <div class="review-stars" style="color: #ffc107;">
                          <i class="fas fa-star"></i>
                          <i class="fas fa-star"></i>
                          <i class="fas fa-star"></i>
                      ...
                      <p class="review-text" style="color: var(--text-light); font-style: italic; line-height: 1.6; margin: 0;">"Mon fils de 9 ans a été captivé par les aventures d'Estevanico. Une belle leçon d'histoire et de courage !"</p>
                    </div>
                  </div>
              ...
              <div class="col-lg-4">
                ...
                <div class="sidebar-card">
                  ...
                  <SessionsDisplay spectacleId="estevanico" />
                  <div class="showtime-item" style="background: var(--bg-light); border-radius: 0.5rem; padding: 1rem; margin-bottom: 1rem; border-left: 4px solid var(--primary-color);">
                    <div class="showtime-date" style="font-weight: 600; color: var(--text-dark); margin-bottom: 0.25rem; font-family: 'Raleway', sans-serif;">10 au 14 Février 2026</div>
                  ...
                  <div class="showtime-item" style="background: var(--bg-light); border-radius: 0.5rem; padding: 1rem; margin-bottom: 1rem; border-left: 4px solid var(--primary-color);">
                    <div class="showtime-date" style="font-weight: 600; color: var(--text-dark); margin-bottom: 0.25rem; font-family: 'Raleway', sans-serif;">17 au 21 Février 2026</div>
                  ...
                  <div class="showtime-item" style="background: var(--bg-light); border-radius: 0.5rem; padding: 1rem; margin-bottom: 1rem; border-left: 4px solid var(--primary-color);">
                    <div class="showtime-date" style="font-weight: 600; color: var(--text-dark); margin-bottom: 0.25rem; font-family: 'Raleway', sans-serif;">Février 2026</div>
                ...
                <div class="sidebar-card">
                  ...
                  <div class="info-item">
                    ...
                    <span>Genre : Aventure historique</span>
                  </div>
                </div>
