      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-primary mb-4 font-heading">
            Réservation - Charlotte
          </h1>
          <p className="text-muted-foreground text-lg">
            Une histoire touchante sur l'amitié et la différence
          </p>
        </div>
            ...
            <Card className="sticky top-8">
              <CardHeader>
                <div className="aspect-[3/4] rounded-lg overflow-hidden mb-4">
                  <img 
                    src="/assets/img/charlotte-poster.jpg" 
                    alt="Charlotte"
                    className="w-full h-full object-cover"
                  />
                </div>
                <CardTitle className="text-center">Charlotte</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>55 MAD par personne</span>
                </div>
                <p className="text-sm text-muted-foreground">
                  L'histoire émouvante de Charlotte, une petite fille différente qui nous enseigne 
                  la beauté de l'acceptation et de l'amitié véritable.
                </p>
              </CardContent>
            </Card>
          </div>
...
export default CharlotteReservation;
