      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-primary mb-4 font-heading">
            Réservation - Estevanico
          </h1>
          <p className="text-muted-foreground text-lg">
            L'aventure extraordinaire d'un explorateur marocain
          </p>
        </div>
            ...
            <Card className="sticky top-8">
              <CardHeader>
                <div className="aspect-[3/4] rounded-lg overflow-hidden mb-4">
                  <img 
                    src="/assets/img/estevanico-poster.jpg" 
                    alt="Estevanico"
                    className="w-full h-full object-cover"
                  />
                </div>
                <CardTitle className="text-center">Estevanico</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>60 MAD par personne</span>
                </div>
                <p className="text-sm text-muted-foreground">
                  Découvrez l'histoire fascinante d'Estevanico, l'explorateur marocain qui a marqué 
                  l'histoire de l'Amérique. Un spectacle qui célèbre le courage et l'aventure.
                </p>
              </CardContent>
            </Card>
          </div>
...
export default EstvanicoReservation;
