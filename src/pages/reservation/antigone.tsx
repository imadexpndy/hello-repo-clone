      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-primary mb-4 font-heading">
            Réservation - Antigone
          </h1>
          <p className="text-muted-foreground text-lg">
            La tragédie grecque revisitée pour les jeunes
          </p>
        </div>
            ...
            <Card className="sticky top-8">
              <CardHeader>
                <div className="aspect-[3/4] rounded-lg overflow-hidden mb-4">
                  <img 
                    src="/assets/img/antigone-poster.jpg" 
                    alt="Antigone"
                    className="w-full h-full object-cover"
                  />
                </div>
                <CardTitle className="text-center">Antigone</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>65 MAD par personne</span>
                </div>
                <p className="text-sm text-muted-foreground">
                  Une adaptation moderne de la tragédie de Sophocle qui explore les thèmes 
                  de la justice, du courage et de la résistance face à l'oppression.
                </p>
              </CardContent>
            </Card>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Ex: contact@lycee.ma"
                      required
                    />
                  </div>
...
export default AntigoneReservation;
