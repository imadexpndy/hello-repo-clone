    ...
    <>
      <style>{`
        ...
        .spectacle-hero {
          ...
          overflow: hidden;
          padding: 0;
          background: url('https://edjs.art/assets/img/Asset 9@4x.png') center/cover, linear-gradient(135deg, #8B4513 0%, #A0522D 100%);
        ...
        <div className="hero-container">
          <div className="hero-left">
            <div className="hero-content">
              <h1 className="hero-title">Antigone</h1>
              <p className="hero-subtitle">La tragédie grecque de Sophocle adaptée pour les jeunes spectateurs</p>
              <div className="info-pills">
                <span className="info-pill">
                  <i className="fas fa-clock"></i>75 minutes
                </span>
                <span className="info-pill">
                ...
                {userType === 'professional' && professionalType === 'scolaire-privee' && (
                  <span className="info-pill">
                    <i className="fas fa-child"></i>Collège, Lycée
                  </span>
                )}
                ...
                <span className="info-pill">
                  <i className="fas fa-theater-masks"></i>Tragédie grecque
                </span>
              </div>
            ...
            <div className="vintage-tv-container" style={{
              ...
              <div className="tv-frame">
                <div className="tv-screen">
                  <img 
                    src="/public/lovable-uploads/antigone-poster.jpg" 
                    alt="Antigone Affiche" 
                    style={{
                      width: '100%', 
                      height: 'auto', 
                      borderRadius: '10px', 
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="content-card">
                ...
                <p>Antigone, la célèbre tragédie de Sophocle, adaptée pour les jeunes spectateurs d'aujourd'hui. Cette œuvre intemporelle explore les conflits entre devoir familial et loi civique, entre conscience individuelle et autorité politique.</p>
                
                <p>Antigone défie l'interdiction du roi Créon et décide d'enterrer son frère Polynéice, considéré comme un traître. Ce geste de résistance civile la mène vers un destin tragique, mais affirme la primauté des lois divines sur les lois humaines.</p>
                
                <p>Cette adaptation moderne rend accessible aux adolescents les grands thèmes de la tragédie grecque : la résistance, la justice, le courage et les valeurs morales face au pouvoir.</p>
              </div>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="info-item">
                      ...
                      <span>Justice et lois divines vs humaines</span>
                    </div>
                    <div className="info-item">
                      <i className="fas fa-fist-raised"></i>
                      <span>Résistance et désobéissance civile</span>
                    </div>
                    <div className="info-item">
                      <i className="fas fa-heart"></i>
                      <span>Devoir familial et loyauté</span>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="info-item">
                      <i className="fas fa-crown"></i>
                      <span>Pouvoir et autorité politique</span>
                    </div>
                    <div className="info-item">
                    ...
                    <div className="info-item">
                      <i className="fas fa-lightbulb"></i>
                      <span>Conscience morale individuelle</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="reviews-list" style={{marginBottom: '2rem'}}>
                  <div className="review-item" style={{padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px', marginBottom: '1rem', borderLeft: '4px solid #BDCF00'}}>
                    <div style={{display: 'flex', alignItems: 'center', marginBottom: '0.5rem'}}>
                      ...
                      <strong style={{color: '#333'}}>Professeur Alami</strong>
                      <span style={{color: '#666', marginLeft: '0.5rem', fontSize: '0.9rem'}}>Lycée Hassan II</span>
                    </div>
                    <p style={{color: '#555', margin: 0}}>"Antigone a profondément marqué nos élèves de terminale. Cette adaptation moderne de la tragédie grecque leur a permis de mieux comprendre les enjeux de résistance et de justice. Excellent travail !"</p>
                  </div>
                  ...
                  <div className="review-item" style={{padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px', marginBottom: '1rem', borderLeft: '4px solid #BDCF00'}}>
                    <div style={{display: 'flex', alignItems: 'center', marginBottom: '0.5rem'}}>
                      ...
                      <strong style={{color: '#333'}}>Yasmine K.</strong>
                      <span style={{color: '#666', marginLeft: '0.5rem', fontSize: '0.9rem'}}>Collège Ibn Sina</span>
                    </div>
                    <p style={{color: '#555', margin: 0}}>"Une représentation puissante qui a suscité de nombreux débats en classe. Les élèves ont été touchés par le courage d'Antigone et ont mieux saisi les dilemmes moraux."</p>
                  </div>
                </div>
            ...
            <div className="col-lg-4">
              ...
              <div className="sidebar-card">
                ...
                {(userType === 'particulier' || !userType) && (
                  <>
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      <div className="showtime-date" style={{fontWeight: 600, color: 'var(--text-dark)', marginBottom: '0.25rem', fontFamily: 'Raleway, sans-serif'}}>Samedi 5 Avril 2025</div>
                    ...
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      <div className="showtime-date" style={{fontWeight: 600, color: 'var(--text-dark)', marginBottom: '0.25rem', fontFamily: 'Raleway, sans-serif'}}>Samedi 12 Avril 2025</div>
                ...
                {professionalType === 'scolaire-privee' && (
                  <>
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      <div className="showtime-date" style={{fontWeight: 600, color: 'var(--text-dark)', marginBottom: '0.25rem', fontFamily: 'Raleway, sans-serif'}}>Lundi 7 Avril 2025</div>
                      ...
                      <button 
                        onClick={() => window.location.href = '/reservation/antigone?session=rabat-apr-7-09h30'}
                        style={{background: 'var(--primary-color)', color: 'white', border: 'none', padding: '0.5rem 1rem', borderRadius: '0.5rem', fontSize: '0.9rem', fontWeight: 500, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.25rem', transition: 'all 0.3s ease', fontFamily: 'Raleway, sans-serif', cursor: 'pointer'}}
                      >
                        <i className="fas fa-ticket-alt"></i>
                        Réserver
                    ...
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      ...
                      <button 
                        onClick={() => window.location.href = '/reservation/antigone?session=rabat-apr-7-14h30'}
                        style={{background: 'var(--primary-color)', color: 'white', border: 'none', padding: '0.5rem 1rem', borderRadius: '0.5rem', fontSize: '0.9rem', fontWeight: 500, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.25rem', transition: 'all 0.3s ease', fontFamily: 'Raleway, sans-serif', cursor: 'pointer'}}
                      >
                        <i className="fas fa-ticket-alt"></i>
                        Réserver
                    ...
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      <div className="showtime-date" style={{fontWeight: 600, color: 'var(--text-dark)', marginBottom: '0.25rem', fontFamily: 'Raleway, sans-serif'}}>Vendredi 11 Avril 2025</div>
                      ...
                      <button 
                        onClick={() => window.location.href = '/reservation/antigone?session=casablanca-apr-11-09h30'}
                        style={{background: 'var(--primary-color)', color: 'white', border: 'none', padding: '0.5rem 1rem', borderRadius: '0.5rem', fontSize: '0.9rem', fontWeight: 500, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.25rem', transition: 'all 0.3s ease', fontFamily: 'Raleway, sans-serif', cursor: 'pointer'}}
                      >
                        <i className="fas fa-ticket-alt"></i>
                        Réserver
                    ...
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      ...
                      <button 
                        onClick={() => window.location.href = '/reservation/antigone?session=casablanca-apr-11-14h30'}
                        style={{background: 'var(--primary-color)', color: 'white', border: 'none', padding: '0.5rem 1rem', borderRadius: '0.5rem', fontSize: '0.9rem', fontWeight: 500, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.25rem', transition: 'all 0.3s ease', fontFamily: 'Raleway, sans-serif', cursor: 'pointer'}}
                      >
                        <i className="fas fa-ticket-alt"></i>
                        Réserver
                ...
                {professionalType === 'scolaire-publique' && (
                  <>
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      <div className="showtime-date" style={{fontWeight: 600, color: 'var(--text-dark)', marginBottom: '0.25rem', fontFamily: 'Raleway, sans-serif'}}>Mardi 8 Avril 2025</div>
                      <div className="showtime-time" style={{color: 'var(--text-light)', fontSize: '0.9rem', marginBottom: '0.75rem', fontFamily: 'Raleway, sans-serif'}}>14H30 - Rabat, Théâtre Bahnini</div>
                      <button 
                    ...
                    <div className="showtime-item" style={{background: 'var(--bg-light)', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem', borderLeft: '4px solid var(--primary-color)'}}>
                      <div className="showtime-date" style={{fontWeight: 600, color: 'var(--text-dark)', marginBottom: '0.25rem', fontFamily: 'Raleway, sans-serif'}}>Jeudi 10 Avril 2025</div>
                      <div className="showtime-time" style={{color: 'var(--text-light)', fontSize: '0.9rem', marginBottom: '0.75rem', fontFamily: 'Raleway, sans-serif'}}>09H30 - Casablanca, Complexe El Hassani</div>
                      <button 
              ...
              <div className="sidebar-card">
                ...
                <div className="info-item">
                  ...
                  <span>Durée : 75 minutes</span>
                </div>
                <div className="info-item">
                  <i className="fas fa-users"></i>
                  <span>Distribution : 5 comédiens</span>
                </div>
                {/* Age recommendation - hidden for private schools */}
                {professionalType !== 'scolaire-privee' && (
                  <div className="info-item">
                    <i className="fas fa-child"></i>
                    <span>Âge recommandé : 12 ans et +</span>
                  </div>
                )}
                ...
                {professionalType === 'scolaire-privee' && (
                  <div className="info-item">
                    ...
                    <span>Niveaux scolaires : Collège et Lycée</span>
                  </div>
                )}
                <div className="info-item">
              ...
              <div className="content-card" style={{textAlign: 'center'}}>
                ...
                <div className="row align-items-center">
                  <div className="col-md-4">
                    <img 
                      src="/src/assets/spectacles affiches/alice chez le .png" 
                      alt="Alice Chez Les Merveilles" 
                      style={{
                        width: '100%',
                        height: 'auto',
                        borderRadius: '12px',
                  ...
                  <div className="col-md-8" style={{textAlign: 'left', paddingLeft: '2rem'}}>
                    <h3 style={{color: '#BDCF00', fontSize: '2rem', marginBottom: '1rem'}}>Alice Chez Les Merveilles</h3>
                    <p style={{color: '#666', fontSize: '1.1rem', lineHeight: '1.6', marginBottom: '1.5rem'}}>
                      L'aventure fantastique d'Alice dans un monde merveilleux plein de personnages excentriques et de situations surprenantes. 
                      Un spectacle féerique qui stimule l'imagination et la créativité.
                    </p>
                    ...
                    <button 
                      ...
                      onClick={() => window.location.href = '/spectacle/alice-chez-les-merveilles'}
                      style={{
                        padding: '0.75rem 2rem', 
                        fontSize: '1rem',
                        display: 'inline-flex',
                    ...
                    >
                      ...
                      Découvrir Alice Chez Les Merveilles
                    </button>
                  </div>
                </div>
              </div>
