-- Complete fix for admin tables - run this in Supabase SQL Editor

-- First, check if tables exist and drop them if they're incomplete
...
-- Create admin_user_permissions table with proper foreign key to profiles
