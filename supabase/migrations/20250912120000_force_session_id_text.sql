-- Force session_id column to be TEXT type in bookings table
-- This handles any remaining UUID constraints or foreign keys

-- Drop the bookings table and recreate it with correct schema
...
CREATE TABLE bookings (
    ...
    spectacle_id TEXT,
    session_id TEXT,  -- This is now TEXT, not UUID
    booking_type TEXT,
...
INSERT INTO bookings SELECT * FROM bookings_backup WHERE EXISTS (SELECT 1 FROM bookings_backup);
